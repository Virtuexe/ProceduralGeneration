        ...
        */
		...
		public static Vector3Int[] FindPath(Vector3Int startTileCoordinates, Vector3Int endTileCoordinates) {
			...
			for (int directionIndex = 0; directionIndex < Direction.Directions.Length; directionIndex++) {
				nodes[startNodeIndex].testGoResult[directionIndex] = TryMove(startNodeIndex, Direction.Directions[directionIndex]);
				if (!nodes[startNodeIndex].testGoResult[directionIndex]) {
					continue;
				}
				for (int secondDirectionIndex = 0; secondDirectionIndex < Direction.Directions.Length; secondDirectionIndex++) {
					...
					if (nodes[startNodeIndex].testGoResult[Direction.Directions[secondDirectionIndex].Index]) {
						...
						DiagonallyTryMove(startNodeIndex, Direction.Directions[directionIndex].RelValue + Direction.Directions[secondDirectionIndex].RelValue);
					}
				}
		...
		private static void DiagonallyTryMove(int sourceNodeIndex, Vector3Int direction) {
